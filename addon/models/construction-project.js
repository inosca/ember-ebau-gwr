...
export default class ConstructionProject extends XMLModel {
  ...
  constructor(...args) {
    ...
    this.EPROID = this.getFieldFromXML("EPROID", Number);
    this.typeOfClient = this.getFieldFromXML("typeOfClient", Number);
    this.typeOfConstruction = this.getFieldFromXML(
      "typeOfConstruction",
      Number
    );
    this.typeOfConstructionProject = this.getFieldFromXML(
      "typeOfConstructionProject",
      Number
    );
    this.typeOfPermit = this.getFieldFromXML("typeOfPermit", Number);
    this.totalCostsOfProject = this.getFieldFromXML(
      "totalCostsOfProject",
      Number
    );
...
// Stuff that returns an error from the api.
// {{#if model.projectStartDate}}
