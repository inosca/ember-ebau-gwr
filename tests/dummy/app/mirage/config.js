...
import GwrLinkFixtures from "./fixtures/gwr-links";
import GwrLinkModel from "./models/gwr-link";
import GwrLinkScenarios from "./scenarios/default";
import ApplicationSerializer from "./serializers/application";

export default function (config) {
  return createServer({
    ...config,
    fixtures: { gwrLinks: GwrLinkFixtures },
    models: { gwrLink: GwrLinkModel },
    scenarios: { default: GwrLinkScenarios },
    serializers: { application: ApplicationSerializer },
    routes() {
